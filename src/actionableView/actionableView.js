            ...
            {(() => {
              ...
              return item.statuses.map((status, statusIndex) => {
                ...
                if (categoryCount[status.category] > 1) {
                  ...
                  solutionNumber = `Solution ${String(occurrenceIndex).padStart(2, '0')}`;
                  solutionLabel = `${status.category} - ${solutionNumber}`;
                } else {
                  solutionLabel = status.category;
                  solutionNumber = 'Solution 01';
                }
                ...
                return (
                  <div 
                    ...
                    onClick={() => handleStatusClick(status, item, solutionNumber)}
                  >
